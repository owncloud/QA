...
Transfer files/folder ownership with reshares in user 1 from user1 to user2 | The files/folders are transferred to user2  and they do not appear for user1 any longer. Reshares will not be kept.| :construction:  |
