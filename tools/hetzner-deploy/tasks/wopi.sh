...
# occ config:system:set wopi.office-online.server --value 'https://mso.owncloud.works'	# certificate expired 202101xx - defunct.
...
echo >> ~/POSTINIT.msg "WOPI:  - To try collabora, run: occ c:s:del wopi.proxy.url; occ c:s:set wopi.office-online.server --value 'https://collabora.owncloud-demo.com'"
