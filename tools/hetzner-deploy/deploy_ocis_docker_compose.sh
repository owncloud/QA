...
source lib/make_machine.sh -t cx31 -u ocis-${OCIS_VERSION} -p git,vim,screen,xattr,file,gdb,jq,docker.io,docker-compose,binutils,ldap-utils,golang-go,python3-pip "$@"
set -x
