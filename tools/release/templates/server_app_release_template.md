...
- [ ] Submit mail-text as a Markting Request via https://kiteworks.monday.com/boards/5983659465/views/130504071 using login name + password, (not SSO)
	- Prompt: convert into 5 lines of enduser friendly marketing language, nothing exciting, no exclamation marks, this release is a minor update only:
	- paste email text, review and edit result.
