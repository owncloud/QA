...
------------ | ------------- | -------------- | ----- | ------
 ...
 | Remove an applicable group to a DropBox mountpoint via command line | The mountpoint is configured and applicable group condition is removed | :construction:  |1 | Remove an applicable group to a GoogleDrive mountpoint via command line | The mountpoint is configured and applicable group condition is removed | :construction:  |
...
| **files_external:backends** |  |   |
 |  |  |   |
 | After configuring some external storages moutnpoints, run backends command via CLI | A list of available authentication and their config options is shown | :construction:  |
