...
12 | Search a remote user in the search box | 1. Open the sharing dialog<br>2. Search the remote user | The remote user should be shown | :construction: ||
13 | (Federate share) Share a folder with a remote user | 1. Open the sharing dialog for a folder<br>2. Search and share with remote user | The folder appears in the remote server | :construction: ||
9 | (Federate share) Share a file with a remote user | 1. Open the sharing dialog for a file<br>2. Search and share with remote user | The file appears in the remote server | :construction: ||
10 | Share a file with a user from SFTP |  | The file appears in the server | :construction: ||
11 | Share a folder with an LDAP user | 1. Open the sharing dialog for a folder<br>2. Search and share with LDAP user | The folder appears in the server | :construction: ||
