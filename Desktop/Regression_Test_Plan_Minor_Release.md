...
6 | Verify shared icon, Win+non-VFS | 1. User share a folder | When the folder or file is shared by link show a special icon | :construction:  | FIXME: not needed? |
7 | Verify shared icon, Win+VFS | 1. User share a folder | No sharing indicator is shown in VFS mode | :construction:  | FIXME: How can the user recognize a shared resource? |
