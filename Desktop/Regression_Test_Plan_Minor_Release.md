...
3 | Share a folder/file with special characters | 1. Open the sharing dialog for the file/folder having special characters (e.g. `<>:?$%ñ&`)<br>2. Search and share with user | The file/folder appears in the server for sharee | :heavy_check_mark: | tst_sharing | :robot: oC10
