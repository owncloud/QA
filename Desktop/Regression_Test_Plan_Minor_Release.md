...
7 | Public link a folder and download it using direct download option | 1. Open Public link dialog<br>2. Create the link share<br>3. Open `...` menu of the create link<br>4. Select **copy public link to clipboard (direct download)**<br>5. Paste link in the browser and download it | zip archive of the folder can be downloaded | :construction: ||
8 | Create a public link share of a file using right click menu | 1. Right click a file<br>2. Open the **ownCloud** menu item<br>3. Click **Create and copy public link to clipboard**<br>4. Paste link in the browser and download it | The file can be downloaded | :construction: ||
