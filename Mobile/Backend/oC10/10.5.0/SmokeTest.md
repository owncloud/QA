...
**Server version**: 10.5RC2<br>
**OAuth2 version**: 0.4.3<br>

### Android

**Device & Android version**: Google Pixel 2 Android10 <br>
**Android app version**: [2.15](https://github.com/owncloud/android/tree/oc-android-2.15)<br>
...
**Device & iOS version**: iPhone XR, iOS13.4<br>
**iOS app version**: [1.3.2](https://github.com/owncloud/ios-app/tree/version_1.3.2)<br>
