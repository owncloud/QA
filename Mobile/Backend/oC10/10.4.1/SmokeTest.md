...
**Device & iOS version**: iPhone XR iOS13<br>
**iOS app version**: [1.3.1](https://github.com/owncloud/ios-app/tree/version_1.3.1)<br>

Test Case | Steps | Expected Result | Result | Related Comment
| :------ | :---- | :-------------- | :----- | :---------
| Login basic | Login in a server with basic auth | It is possible to access  | Passed |
| Login OAuth2 | Login in a server with OAuth2  | It is possible to access  | Passd |
