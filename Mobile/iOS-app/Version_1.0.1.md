...
| Log Rotation | Change device date and generate some logs  |  New log file is created | P m1  |  |
...
| Upload a bunch of files | Select "Upload from  Files in a non-root folder<br>Select a huge a,ount of files| All files are uplaoded | F m12 | Many alerts if the connection is lost|
