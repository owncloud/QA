...
#### PR: https://github.com/owncloud/ios-app/issues/827<br>


Device/s: iPhoneXR v14.1<br>
Server: 10.5.0
...
| :-------- | :---- | :-------------- | :----: | :------------- |
|**Auth**| two devices|||||
| Basic auth http | 1. Type an correct URL to the app with http and basic auth | 2. Host certificate is there. Credentials are asked  | P m14 t13 |  |
...
| OAuth2 http | 1. Type an correct URL to the app with OAuth2 and http | 2. Host certificate is there. Switch to web View  | P m14 t13   |  |
| OAuth2 https | 1. Type an correct URL to the app with OAuth2 and https | 2. Host certificate is there, asked from approval. Switch to web View  |  P m14 t13  |  |
...
| OAuth2 right credentials | 1. Type an correct URL to the app with O2uth3<br>Type correct credentials in web view and authorize | File list accesible | P m14 t13  |  |
| Basic auth wrong credentials | 1. Type an correct URL to the app with basic auth<br>Type wrong credentials | Error |  P m14 t13  |  |
| OIDC | 1. Type an correct URL to the app with OIDC auth<br>Type correct credentials | File list accesible | P m14 t13   |  |
|**Settings**||||||
...
| Certificate different key | 1. Attach one account to the app with non-secure https, accepting the certificate<br>2. In Settings, open "Certificates"<br>3. Revoke the certificate<br>4. Add an account in the same server | 2. Host certificate is there.<br>4. Certificate Approval is asked  | P m14 |  |
...
| Non openable | Download an open a non openable file | Placeholder displayed with date and size|P m14 |  |
