...
| 26 | Reshare v8 → v9 |  1. Swipe to share a file in v9 with an federated user in v9 granting him to share<br>2. Login with the sharee<br>3. Try to reshare with other users in the same server| 3. The share privilege is enabled<br>4. Resharing is not allowed |||
