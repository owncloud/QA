...
| 2 | From scratch leaving| 1. Install the app<br>2. Login in the app | Login process is completed  after passcode is required|  |  |
...
| 7 | Session renewal without leaving| 1. Wait until session expires<br>2. Type the passcode<br>3. Login in the app  | Login process is completed  |  |  |
| 8 | Session renewal leaving| 1. Wait until session expires<br>2. Type the passcode<br>3. Login in the app. Leave the app in the middle of the process and enter again (change orientation)| Login process is completed  after passcode is required|  |  |
...
| 14 | From scratch leaving| 1. Install the app<br>2. Input passcode<br>3. First step<br>4. Leave the app (change orientation)<br>5. Second step  | 1. Passcode asked<br> 5.Login process is completed after passcode is required |  |  |
