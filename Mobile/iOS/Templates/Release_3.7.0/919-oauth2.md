...
| 37 | Change credentials | After login, in settings view, go to edit credentials | New token is received |  |  |
...
| 52 | Migrate basic to OAuth2| 1. Login in a basic older server<br>2. Upgrade by migrating to a OAuth2 server | Migration OK |  |  |
| 53 | Migrate SAML to OAuth2| 1. Login in a older SAML server<br>2. Upgrade by migrating to a OAuth2 server | Migration OK |  |  |