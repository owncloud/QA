...
Device: iPadAir v8.2 , iPhone 6S plus v9.1
...
| :----: | :-------- | :---- | :-------------- | :----: | :------ |
|**View**||||||
| 1 | Switch button version >= 9.1 | 1. Login in server 9.1<br>2. Share a file and a folder with a user in another server<br>3. Tap on (i) | A switch button "Can share" is displayed (check in both orientations) | P t8 m9 |  |
| 2 | Switch button version < 9.1 | 1. Login in server 9.0 or 8.2<br>2. Share a file and a folder with a user in another server<br>3. Tap on (i) | A switch button "Can share" is not displayed (check in both orientations) | P t8  m9 |  |
...
| 7 | Share permission | 1. Login in server 9.1<br>2. Share a file and a folder with a user in another server<br>3. Tap on (i) and enable "Can share"<br>4. In server, accept the share<br>5. In app, re-share the content by link|4. The file/folder appear in file list<br>5. Content can be shared, the link works| P t8 m9 |  |
