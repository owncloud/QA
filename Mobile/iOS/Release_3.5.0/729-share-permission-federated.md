...
| :----: | :-------- | :---- | :-------------- | :----: | :------ |
|**View**||||||
| 1 | Switch button version >= 9.1 | 1. Login in server 9.1<br>2. Share a file and a folder with a user in another server<br>3. Tap on (i) | A switch button "Can share" is displayed (check in both orientations) | P t8 |  |
| 2 | Switch button version < 9.1 | 1. Login in server 9.0 or 8.2<br>2. Share a file and a folder with a user in another server<br>3. Tap on (i) | A switch button "Can share" is not displayed (check in both orientations) | P t8 |  |
