...
|**Creation**||||||
| 4 | Name | 1. Open Share view<br>2. Add a public link with name. Other options default  | Public link created. Check in server | F m10 t9 m9  | FIXED: special characters. Improvement: show keyboard and set the cursor in the name field after opening the creation view |
