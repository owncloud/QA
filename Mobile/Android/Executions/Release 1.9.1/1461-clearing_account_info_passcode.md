...
| 2 | Clear data with passcode (http server)| 1. Set a passcode in the app<br>2. Go to Settings > Apps > ownCloud > Storage > Manage Space and clear data. <br> 3. Enter the app | The passcode is required. All data (settings, database) are removed | P m4a m4b t9 m5 m4c| SOLVED: Settings are not cleared. App crash in a pic is opened when clearing
