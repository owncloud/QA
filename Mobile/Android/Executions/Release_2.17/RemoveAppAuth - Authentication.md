...
| :-------- | :---- | :------- | :----: | :--------------- | 
|**View**||||||
| Portrait | Open login view in portrait orientation | Everything correct placed<br>Check the disclosure button and the password eye are visibles | P m11 m7 |  |
| Landscape | Open login view in landscape orientation | Everything correct placed<br>Check the disclosure button and the password eye are visibles | P m11 m7 |  |
| New to ownCloud | Tap on the link "New to ownCloud" | Link works | P m11 m7 |  |
|**URL validation**||||||
| Empty URL | Let empty URL | 1. Correct issue indicating error<br>2. Login button not displyed | P m11 m7 |  |
| Prefix http | Input correct http URL with protocol | Accepted | P m11 m7|  |
| Prefix https | Input correct https URL with protocol | Accepted | P m11 m7|  |
| No prefix http | Input correct http URL without protocol | Accepted | P m11 m7 |  |
| No prefix https | Input correct https URL without protocol | Accepted | P m11 m7 |  |
| Icon check | 1. Input correct URL<br>2. Tap on ownClouud icon| URL checked | P m11 m7 |  |
| Incorrect URL | Set Incorrect URL | 1. Correct issue indicating error<br>2. Login button not displyed | P m11 m7|  |
| Server not reachable | Set a correct URL but with no reachable server (f. ex. invalid port) | 1. Correct issue indicating error<br>2. Login button not displyed | P m11 m7 |  |
| Incorrect prefix http | Input http URL with "https://" prefix | 1. SSL initialization error<br>2. Login button not displyed | P m11 m7 |  |
| Incorrect prefix https | Input https URL with "http://" prefix | Connection established | P m11 m7 |  |
| Bad prefix | Input https URL with "http:::::////" prefix | Wrong format error | P m11 m7 |  |
| No internet connection | 1. Disable internet connection in device<br>2. Input URL | Correct error | P m11 m7 |  |
| No server connection | 1. Switch server off in device<br>2. Input URL | Correct error |P m11 m7  |  |
| Server not supported | Input URL of non supported server (older than 10) | Correct error | P m11 m7|  |
| Maintenance mode | 1. Enable maintenance mode<br>2. Input error | Correct error | P m11 m7 |  |
|**Review Connection**||||||
| Open certificate | Open certificate to check details | Certificate shown correctly | P m11 m7 |  |  |
| Approve certificate | Open certificate to check details and approve it | 1. Moved forward to credentials basic/OAuth<br>2. Login button not displyed  | P m11 m7|  |  |
| Cancel certificate | 1. Open certificate to check details<br>2. Cancel it | Back to URL |P m11 m7 |  |  |
|**Basic auth**||||||
| Empty credentials | Connect with empty credentials | Connect button not displayed  | P m11 m7 |  | 
| Empty username | Connect with empty username | Connect button not displayed | P m11 m7|  |
| Empty password | Connect with empty password | Connect button not displayed | P m11 m7 |  |
| Correct credentials | Connect with correct username and passowrd | Correct connected | P m11 m7 |  | 
| Special characters | Connect with username that contains special characters | Correct connected | P m11  m7|  | 
| Username with blanks | Connect with username that contains blanks | Correctly connected  | P m11 m7|  |
| Password eye | 1. Input a password<br>2. Click on eye button | Password is correctly displayed/hidden | P m11 m7 |  |
|**OAuth2**||||||
