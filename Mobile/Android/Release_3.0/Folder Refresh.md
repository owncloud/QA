...
| Rename non-downlaoded file | 1. In server, rename an existing file<br>2. In app, pull down to refresh | Renamed file listed in correct place depending on the sorting method, check by browsing forth and back |  |
| Rename downlaoded file | 1. In app, download a file<br>2. In server, rename the file<br>3. In app, pull down to refresh | Renamed file listed in correct place depending on the sorting method, check by browsing forth and back<br>File is still downloaded  |  |
...
| Rename downlaoded folder | 1. In app, download a folder (all content inside)<br>2. In server, rename the folder<br>3. In app, pull down to refresh | Renamed folder listed in correct place depending on the sorting method, check by browsing forth and back<br>Files inside are still downloaded  |  |
