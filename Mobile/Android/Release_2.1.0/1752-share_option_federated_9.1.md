...
| 8 | Share permission | 1. Login in server 9.1<br>2. Share a file and a folder with a user in another server<br>3. Tap on (>) and enable "Can share"<br>4. In server, accept the share<br>5. In app, re-share the content by link|4. The file/folder appear in file list<br>5. Content can be shared, the link works|  |  |
| 9 | No share permission| 1. Login in server 9.1<br>2. Share a file and a folder with a user in another server<br>3. Tap on (>) and disable "Can share"<br>4. In server, accept the share<br>5. In app, share the content by link|4. The file/folder appear in file list<br>5. Content is not shared |  |  |
|**Previous behaviour**||||||
...
| 11 | 9.0/8.x share by link  | 1. Login in server 9.0/8.x<br>2. Share a file and a folder with a user in another server<br>3. In server, accept the share<br>4. In app, re-share the content by link|3. The file/folder appear in file list<br>4. Resharing allowed|  |  |
