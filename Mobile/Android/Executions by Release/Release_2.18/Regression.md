...
#### PR: [https://github.com/owncloud/android/issues/3243]([https://github.com/owncloud/android/issues/3243])<br>


Device/s: Pixel2 v11, Nexus 6P v7, Huawei P10 v6<br>
Server: 10.7
...
Features not tested (not affected for the news in the release): multiselection, conflicting
...
| With blanks | Set some blanks after and before user name | Correct access |P m11 m7| 
