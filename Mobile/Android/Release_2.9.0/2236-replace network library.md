...
| 1 | Send (not downloaded)  | Downloaded first, then Send | P m8 | | |
|**Av. offline**||||||
...
|**Sharing**||||||
| 1 | Private link | Works properly | | | 
| 1 | Share file with user | File shared | | | 
| 1 | Share folder with user | Folder shared | | | 
| 1 | Share file with group | File shared | | | 
| 1 | Share folder with group | Folder shared | | | 
| 1 | Share folder with create permission | Folder shared with create permission (check others are not) | | | 
| 1 | Share folder with edit permission | Folder shared with edit permission (check others are not) | | | 
| 1 | Share folder with delete permission | Folder shared with delete permission (check others are not) | | | 
| 1 | Share folder with reshare permission | Folder shared with reshare permission (check others are not) | | | 
| 1 | Share folder with all permissions | Folder shared with all permission | | | 
| 1 | Share folder with no permissions | Folder shared with no permission| | | 
| 1 | Share file with edit permissions | File shared with edit permission| | | 
| 1 | Share file with reshare permissions | File shared with reshare permission| | | 
| 1 | Share file with all permissions | File shared with all permission | | | 
| 1 | Share file with no permissions | File shared with no permission| | | 
| 1 | Federated share | Content shared | | | 
| 1 | Unshare | Content unshared | | | 
| 1 | Create Private share default | Correctly created | | | 
| 1 | Create Private share name | Correctly created | | | 
| 1 | Create Private share expiration | Correctly created | | | 
| 1 | Create Private share password | Correctly created | | | 
| 1 | Create Private share expiration + password | Correctly created | | | 
| 1 | Create Private share download/view | Correctly created | | | 
| 1 | Create Private share download/view/upload | Correctly created | | | 
| 1 | Create Private share upload only | Correctly created | | | 
| 1 | Update Private share name | Correctly updated | | | 
| 1 | Update Private share expiration | Correctly updated | | | 
| 1 | Update Private share password | Correctly updated | | | 
| 1 | Update Private share expiration + password | Correctly updated | | | 
| 1 | Update Private share download/view | Correctly updated | | | 
| 1 | Update Private share download/view/upload | Correctly updated | | | 
| 1 | Update Private share upload only | Correctly updated | | | 
| 1 | Remove private share| Correctly deleted | | | 
