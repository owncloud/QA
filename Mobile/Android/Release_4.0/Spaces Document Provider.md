...
| Space disabled | 1. Add oCIS accounts<br>2. In web, disable exiting space<br>3. Open any app with access to Document Provider | Disabled space is not listed | F m12 | Disabled space listed |
|**Spaces content**||||
