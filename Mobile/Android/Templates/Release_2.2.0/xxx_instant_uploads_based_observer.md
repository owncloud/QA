...
| 3 | Photos enabled again |  1. From 2., enable again instant uploads<br>2. Take more photos  | Only new photos are uploaded. Check in uploads view  |  |  |
| 4 | Video |  1. Enable instant uploads for photos, but not for videos<br>2. Take a video | Video is not uploaded. Check in uploads view |  |  |
| 5 | Upload path |  1. With the instant uploads enabled, change the upload path<br>2. Take a photo  | Photo is uploaded in the correct path. Check the uploads view. |  |  |
| 6 | Move |  1. With the instant uploads enabled, change to "Move to app folder"<br>2. Take a photo  | Photo is uploaded in the correct path and not stored in device storage. Check the uploads view. |  |  |
...
| 8 | Video enabled |  1. Enable instant uploads for videos<br>2. Take a video  | Video is uploaded. Check the uploads view. |  |  |
| 9 | Video disabled |  1. Disable instant uploads for videos<br>2. Take a video  | Video is not uploaded. Check the uploads view. |  |  |
