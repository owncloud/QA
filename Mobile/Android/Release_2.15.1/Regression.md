...
| **Redirections** |   |  |
| Actions on a redirect servers (301) | 1. Log in no self signed servers<br>2. Create a folder<br>3. Upload a file<br>4. Share a file by link<br>5. Share a file with another user | All actions OK | F m10 | unknown error
| Actions on a redirect servers (302) | 1. Log in no self signed servers<br>2. Create a folder<br>3. Upload a file<br>4. Share a file by link<br>5. Share a file with another user | All actions OK | F m10 | unknown error
| **Accounts manager** |   |  |
...
|**File operations**||||||
| Move one file | Moved to target| P m10 | | | 
| Move one folder | Moved to target| P m10 | | | 
| Move one folder to itself | Correct error | P m10 | | | 
| Move several items | Moved correctly | P m10 | | | 
| Move without connection| Correct error |  P m10| | | 
| Copy one file | Copied to target| P m10 | | | 
| Copy one folder | Copied to target|  P m10| | | 
| Copy one folder to itself | Correct error | P m10 | | | 
| Copy several items | Copied correctly | P m10 | | | 
...
| Rename one file | Renamed | P m10 | | | 
| Rename one folder | Renamed | P m10 | | | 
